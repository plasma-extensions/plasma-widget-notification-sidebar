#!/bin/sh
BUGADDR="https://github.com/plasma-extensions/plasma-widget-notification-sidebar/issues"  # MSGID-Bugs
PROJECT="plasma-widget-notification-sidebar"   # project name
